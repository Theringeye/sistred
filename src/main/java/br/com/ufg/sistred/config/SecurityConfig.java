...
import br.com.ufg.sistred.security.JWTAutenticarFiltro;
 ...
 * @Descricao: Classe responsavel por manter as configurações de segurança do
 *             SpringSecurity, inclusive do JWT
 */
@Configuration
@EnableWebSecurity
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		httpSecurity.csrf().disable()
				...
				.authorizeRequests()
				.antMatchers("/usuario/listarTodos", "/usuario", "/login", "/questions/paged",
